...
wait
echo "Created figures exp: 00 01 02 03 04 05" >> last_runs.log
...
wait
echo "Created figures exp: 06 07 08 09 10 11" >> last_runs.log
...
wait
echo "Created figures exp: 12 13 14 15 16 17" >> last_runs.log
