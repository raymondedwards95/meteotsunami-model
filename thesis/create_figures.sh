...
echo "$(date) - Starting creation of figures exp"
echo "$(date) - Starting creation of figures exp" >> last_runs.log
...
wait
echo "$(date) - Created figures exp: 00 01 02 03 04 05"
...
wait
echo "$(date) - Created figures exp: 06 07 08 09 10 11"
...
wait
echo "$(date) - Created figures exp: 12 13 14 15 16 17"
echo "$(date) - Created figures exp: 12 13 14 15 16 17" >> last_runs.log

wait
echo "$(date) - Created all figures exp"
echo "$(date) - Created all figures exp" >> last_runs.log
